...
const Recommendations = () => {
  return (
    <DashboardLayout title="Recommended Courses">
      <div className="bg-white rounded-xl shadow-md p-6">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-[#592538] mb-2">Recommended Courses</h1>
          <p className="text-gray-600">Discover courses to enhance your skills and advance your career</p>
        </div>
